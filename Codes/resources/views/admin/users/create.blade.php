        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-9">
                            <h2>{{ _t(__('message.add',['name' =>_t(__('message.user')) ])) }}</h2>
                        </div>
                        <div class="col-md-3">
                ...
                {{ Form::open(['method' => 'post', 'route' => 'users.store', 'data-toggle' => 'validator', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) }}
                <div class="card-body">
