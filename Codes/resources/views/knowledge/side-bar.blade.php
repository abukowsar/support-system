<div class="col-lg-4 col-md-12 col-sm-12">
    <div class="iq-post-sidebar">
        @if(isset($search))
            ...
            <div class="iq-sidebar-widget bg-w2">
                ...
                <div class="iq-widget-search"><i class="fa fa-search"></i>
                    <input type="search" name="keywords" placeholder="Search...."
                           class="form-control placeholder filter-change">
                </div>
            </div>
                        ...
                        @foreach($articleCategory as $category)
                            <li>
                                <a href="{{route('knowledgebase.list',['category'=>$category->slug])}}">
                                    <span class="{{ $category_id== $category->id ? 'main-color':''}}">
                                        {{ _t(ucfirst(stringLong($category->category_name,'title', 0))) }} 
